...
const Tips = () => {
  ...
  return (
    <section className="tips p-8 bg-gradient-to-r from-blue-100 to-green-100">
      <h2 className="text-4xl font-bold mb-6 text-center text-gray-800">Tips for Effective Vocabulary Learning</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {tips.map((tip, index) => (
          <div key={index} className="tip-card p-6 border border-gray-300 rounded-lg shadow-lg hover:shadow-xl transition duration-300 bg-white">
            <h3 className="font-semibold text-2xl text-blue-600">{tip.title}</h3>
